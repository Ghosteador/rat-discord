...
Remote control tool via Discord
Contains more than 40 executable commands

DISCLAIMER---
This tool is for educational use only, the author will not be responsible for misuse of this tool.
...
This project was created by ghosteador - LostSquad
